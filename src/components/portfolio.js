        ...
        <div class="container portfolioContainer">
            ...
            <div class="row gruscery">
                ...
                <div class="col-md-6">
                    ...
                    <p className="projectDescription">Real-time grocery list app built with React.JS, Node.JS and PostgreSQL utilizing TDD and RESTful API. Users are able to create, modify and collaborate on grocery shopping lists.  <a href="https://gruscery-list.herokuapp.com/" className="projectLink">Link</a></p>
            ...
            <div class="row trek">
                ...
                <div class="col-md-6">
                    ...
                    <p className="projectDescription">Rich single-page application built with React.JS, Firebase for auth and storage. Integrated with a hiking API to allow users to see list of hikes based on zip code. Users can create hiking groups with designated hike and time that other users can join.  <a href="https://trek-tribe.herokuapp.com/" className="projectLink">Link</a></p>
            ...
            <div class="row wanipedia">
                ...
                <div class="col-md-6">
                    ...
                    <p className="projectDescription">Web app that allows users to create, collaborate and share wikis. Built with Node.JS using TDD and RESTful services. Integration with Stripe for users to upgrade membership. Implemented email sending and user authentication with SendGrid and Passport.JS.   <a href="https://kentonwan-blocipedia.herokuapp.com/" className="projectLink">Link</a></p>
